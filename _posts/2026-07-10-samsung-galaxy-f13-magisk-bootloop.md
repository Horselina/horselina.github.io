...
date: 2026-07-10
category: android
tags: [android, samsung, magisk, odin, root, bootloop, exynos, knox]
description: "A personal experiment documenting the complete process of rooting a Samsung Galaxy F13 - the OEM unlock wait, Magisk patching, Odin flashing, and recovering from a bootloop."
---
...
3. **Pre-Owned Device Wait Times (Prenormal KG State)**: While this waiting period isn't required for every device, it was necessary in my case. Because my device was a pre-owned global model stuck in a "prenormal" KG (Knox Guard) state, **it had to remain connected to Wi-Fi and a SIM card for 7 days (168 hours)** before the toggle became available. While some people attempt to bypass this timer by manually tweaking the device's date and time settings, I preferred to simply wait it out over a standard SIM-based connection.
 ...
 ![Screenshot showing the OEM Unlock toggle grayed out in Developer Options](/assets/images/samsung-root/greyed_out.png)
...
![Screenshot showing the OEM Unlock toggle enabled in Developer Options](/assets/images/samsung-root/samsung_oem_unlock_enabled.png)
...
![Samsung Galaxy F13 showing the Download Mode screen with "Downloading... Do not turn off target" warning](/assets/images/samsung-root/galaxy-f13-download-mode.png)
...
![Odin flashing tool](/assets/images/samsung-root/odin_interface.png)
...
![Odin showing green PASS message in the message box after successful flash](/assets/images/samsung-root/odin-pass-screen.png)
...
5. This cycle **repeated indefinitely**
 ...
 ![Samsung Galaxy F13 stuck on the Samsung Galaxy boot logo, unable to proceed to Android](/assets/images/samsung-root/samsung_bootloop.jpeg)
...
*Status: Bootloop encountered — recovery successful*
